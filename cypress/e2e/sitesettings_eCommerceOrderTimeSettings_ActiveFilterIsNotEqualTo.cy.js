describe('Setting Is Not Equal To filter condition under Active Column', () => {
    it('should display only list items where Active Column Is Not Equal To the specified text', () => {
