describe('Setting Contain Filter condition under Active Column', () => {
    it('should display only the item list where Active column contains the specified text in the filter condition', () => {
