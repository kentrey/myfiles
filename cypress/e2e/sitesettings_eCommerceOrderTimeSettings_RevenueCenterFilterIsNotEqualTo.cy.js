describe('Setting Is Not Equal To filter condition under Revenue Center column', () => {
    it('should display only list items where Revenue Center Is Not Equal to the specified text in the filter condition', () => {
      ...
      cy.wait(2000);
      cy.get('#RevenueCenteroption').select('Is not equal to');
